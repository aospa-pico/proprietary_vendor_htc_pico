...
PRODUCT_COPY_FILES += \
    ...
    vendor/htc/pico/lib/libgsl.so:system/vendor/lib/libgsl.so \
    vendor/htc/pico/lib/libadreno_utils.so:system/vendor/lib/libadreno_utils.so \
    vendor/htc/pico/lib/libOpenCL.so:system/vendor/lib/libOpenCL.so \
    vendor/htc/pico/lib/libOpenVG.so:system/vendor/lib/libOpenVG.so \
    vendor/htc/pico/lib/libsc-a2xx.so:system/vendor/lib/libsc-a2xx.so \
    vendor/htc/pico/lib/libC2D2.so:system/vendor/lib/libC2D2.so \
    vendor/htc/pico/lib/libc2d2_z180.so:system/vendor/lib/libc2d2_z180.so \
    vendor/htc/pico/lib/egl/eglsubAndroid.so:system/vendor/lib/egl/eglsubAndroid.so \
    vendor/htc/pico/lib/egl/libEGL_adreno.so:system/vendor/lib/egl/libEGL_adreno.so \
    vendor/htc/pico/lib/egl/libGLESv1_CM_adreno.so:system/vendor/lib/egl/libGLESv1_CM_adreno.so \
    vendor/htc/pico/lib/egl/libGLESv2_adreno.so:system/vendor/lib/egl/libGLESv2_adreno.so \
    vendor/htc/pico/lib/egl/libGLESv2S3D_adreno.so:system/vendor/lib/egl/libGLESv2S3D_adreno.so \
    vendor/htc/pico/lib/egl/libq3dtools_adreno.so:system/vendorlib/egl/libq3dtools_adreno.so
